...
export const DoctorContentType = contentType({
  ...
  properties: {
    ...
    specialty: { type: 'string', displayName: 'Specialty', group: 'demo' },
    rating: { type: 'string', displayName: 'Rating', group: 'demo' },
    reviews: { type: 'string', displayName: 'Reviews', group: 'demo' },
    ...
    imageAlt: { type: 'string', displayName: 'Photo Alt Text', group: 'demo' },
    profileLink: { type: 'link', displayName: 'Profile Link', group: 'demo' },
    bookLink: { type: 'link', displayName: 'Book Link', group: 'demo' },
  },
});
...
export const FeaturedDoctorsContentType = contentType({
  ...
  properties: {
    ...
    directoryLabel: { type: 'string', displayName: 'Directory Label', group: 'demo' },
    directoryLink: { type: 'link', displayName: 'Directory Link', group: 'demo' },
    doctors: {
      type: 'array',
      displayName: 'Doctors',
      group: 'demo',
