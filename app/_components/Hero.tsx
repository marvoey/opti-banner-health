...
const Hero = ({ data }: { data: HeroContent }) => (
  <section className="relative w-full h-[600px] overflow-hidden bg-slate-900" data-cms-component="HeroBanner">
    ...
    <div className="absolute inset-0 opacity-80 transition-transform duration-700 hover:scale-105">
      <img
        src={data.imageUrl}
        alt="Louisiana Blue health coverage"
    ...
    <div className="relative container mx-auto px-4 h-full flex items-center">
      <div className="max-w-2xl text-white">
        <span className="inline-block px-3 py-1 bg-blue-400 text-blue-950 font-bold text-xs uppercase tracking-widest rounded mb-4 animate-fade-in" data-cms-field="kicker">
          {data.kicker}
        </span>
        ...
        <div className="flex flex-wrap gap-4">
          <button className="px-8 py-4 bg-white text-blue-900 font-bold rounded-full text-lg hover:bg-blue-50 transform transition-all hover:scale-105 shadow-lg active:scale-95" data-cms-field="primaryCTA">
            {data.primaryCTA}
          </button>
