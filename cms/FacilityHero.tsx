...
export const FacilityHeroContentType = contentType({
  ...
  properties: {
    ...
    addressLine1: { type: 'string', displayName: 'Address Line 1', group: 'demo' },
    addressLine2: { type: 'string', displayName: 'Address Line 2', group: 'demo' },
    ...
    specializationsTitle: { type: 'string', displayName: 'Specializations Title', group: 'demo' },
    specializations: {
      type: 'array',
