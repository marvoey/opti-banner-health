...
export const FacilityInfoContentType = contentType({
  ...
  properties: {
    ...
    infoOneLabel: { type: 'string', displayName: 'Info 1 — Label', group: 'demo' },
    infoOnePrimary: { type: 'string', displayName: 'Info 1 — Primary', group: 'demo' },
    infoOneSecondary: { type: 'string', displayName: 'Info 1 — Secondary', group: 'demo' },
    infoTwoLabel: { type: 'string', displayName: 'Info 2 — Label', group: 'demo' },
    infoTwoPrimary: { type: 'string', displayName: 'Info 2 — Primary', group: 'demo' },
    infoTwoSecondary: { type: 'string', displayName: 'Info 2 — Secondary', group: 'demo' },
    disclaimer: { type: 'string', displayName: 'Disclaimer', group: 'demo' },
  },
});
